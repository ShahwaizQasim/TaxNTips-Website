...
const AccountingFeatures: React.FC = () => {
  ...
  return (
    <section className="bg-[#111] min-h-screen flex flex-col items-center justify-center py-16 px-4">
      ...
      <center>
        <motion.h1
          className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6 flex flex-col justify-center"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-24 gap-y-8 w-full max-w-5xl mt-3">
        {features.map((feature, idx) => (
          <div
            key={idx}
            className="flex items-center gap-6 py-6 relative group z-10"
  ...
  `}
            >
              <Image
                ...
                alt="feature"
                fill
                className="object-cover opacity-20 rounded-sm"
              />
            </div>
