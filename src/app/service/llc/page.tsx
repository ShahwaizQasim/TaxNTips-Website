                ...
                >
                  <Instagram size={22} />
                    ...
                    <div className=" absolute top-64 lg:left-80 left-20  ">
                        <h1 className="text-5xl font-bold">Business & LLC Set-Up</h1>
                        <div className="py-4 mt-4 rounded-[30px] flex gap-3 justify-center items-center border-1 border-orange-400 bg-[#34393D]">
                            ...
                            <Link href={'/service/llc'} className="cursor-none interactive">
                                <h1> Business & LLC Set-Up</h1>
                            </Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2">
                            ...
                            <div className="flex flex-col gap-8 items-center ">
                                <div>
                                    ...
                                    <div className="space-y-4 text-gray-600">
                                        <img src="/llc.avif" alt="" className='w-full h-full rounded-2xl' />
                        ...
                        <section className="bg-white rounded-lg p-8 mb-8 relative bottom-[50px]">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">
                                Start Your Business the Right Way with Tax N Tips
                            </h2>
